        ...
        <div class="col-lg-4">
            <div class="nk-feature-1">
                ...
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title"><a href="game-zone.php">Play & Win</a></h3>
                    <p>Start playing & win lot's of prizes<br></p>
                    <h4 class="nk-feature-title text-main-1"><a href="game-zone.php">Start</a></h4>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="nk-feature-1">
                ...
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title"><a href="#">Ray-Ban Forever</a></h3>
                    <p>Everthing that you always wanted to know</p>
                    <h4 class="nk-feature-title text-main-1"><a href="#">Explore</a></h4>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
