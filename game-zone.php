...
<div class="container">
    <ul class="nk-breadcrumbs">
         ...
         <li><span> Choose Your Battle</span></li>
...
<div class="container">
	<div class="row vertical-gap">
        ...
        <div class="col-lg-6">
            <div class="nk-feature-1">
                <div class="nk-feature-icon">
                    <img src="assets/images/game-zone/rapid-fire.png" alt="">
                </div>
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title">Game A</h3>
                    <h3 class="nk-feature-title text-main-1">Rapid Fire</h3>
                    <a href="#" class="nk-btn nk-btn-sm nk-btn-rounded nk-btn-color-white btn-block">Play Game</a>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="nk-feature-1">
                <div class="nk-feature-icon">
                    <img src="assets/images/game-zone/puzzle.png" alt="">
                </div>
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title">Game B</h3>
                    <h3 class="nk-feature-title text-main-1">Puzzle</h3>
                     <a href="#" class="nk-btn nk-btn-sm nk-btn-rounded nk-btn-color-white btn-block">Play Game</a>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="nk-feature-1">
                <div class="nk-feature-icon">
                    <img src="assets/images/game-zone/display-contest.png" alt="">
                </div>
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title">Game C</h3>
                    <h3 class="nk-feature-title text-main-1">Compare Pics</h3>
                    <a href="#" class="nk-btn nk-btn-sm nk-btn-rounded nk-btn-color-white btn-block">Play Game</a>
                </div>
            </div>
        </div>
...
<div class="nk-widget nk-widget-highlighted">
    ...
    <h3 class="nk-decorated-h-2"><span><span class="text-main-1"><span>How to Play</span></h3>
    <div class="nk-gap"></div>
    
    <div class="nk-gap-2"></div>
    <div class="row vertical-gap">
        <div class="col-lg-12">
            <p class="text-white">1. Choose your game from our mutiple options, Game A, Game B and Game C to play it. <br>
            2. Every level has 3 games to play.<br>
            3. Complete all games to increase the score.<br>
            4. Player can play a single game at a single time.<br>
            5. Player can have flexibility to play game mutliple times to increase the score.
            6. Be a warrior, choose your battle field and win the lots of games.
            </p>
        </div>
    </div>
    <!-- END: About -->
    ...
    <!-- START: About -->
    <div class="nk-gap-4"></div>
    <h3 class="nk-decorated-h-2"><span><span class="text-main-1"><span>Rules</span></h3>
    <div class="nk-gap"></div>
    
    <div class="nk-gap-2"></div>
    <div class="row vertical-gap">
        <div class="col-lg-12">
            <p class="text-white">Contest will be start from August 2017<br>
            Contest have some levels and every level have 3 games to play in the form of questions, puzzles, pictures etc.<br>    
            For each correct answer, you get some points. No negative marking.<br>
            The questions also need to be answered in as less time as possible to go up the rankings. TIMING IS CRUCIAL. So, answer as soon as you can.<br>
            Reedem Point to win the prizes<br>
             Government Taxes, as applicable, must be paid by the winners.
            </p>
        </div>
    </div>
    <!-- END: About -->
